...
-- bind("n", "sr", "<cmd>lua require('telescope.builtin').lsp_references()<cr>", opts)
-- bind("n", "so", "<cmd>lua require('telescope.builtin').lsp_document_symbols()<cr>", opts)
-- bind("n", "sh", "<cmd>lua require('telescope.builtin').help_tags()<cr>", opts)
